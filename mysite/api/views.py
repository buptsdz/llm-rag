...
from .service.chatrag import ChatRAGService  # 使用servic中的chatrag来实现
import json
import openai
...
base_url = os.environ["TONGYI_API_BASE_URL"]
model = os.environ["TONGYI_API_MODEL"]

# 定义默认参数
params = {"api_key_openai": api_key, "base_url": base_url, "model": model}
